                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('orders.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="status" class="form-control{{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" value="{{ old('status') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="track_code" type="track_code" class="form-control{{ $errors->has('track_code') ? 'is-invalid' : ''}}" name="track_code" value="{{ old('track_code') }}">
